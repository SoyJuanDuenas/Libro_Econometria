...
-   **Numericas:** datos que tienen numeros, pueden ser continuos (admiten decimales) o discretos (no admiten decimales)

-   **Logicas:** Solo admiten dos valores, `True` o `False`

-   **Caracteres:** Cadena de caracteres, lease palabras

-   **Complejas:** Objetos que pertenecen al plano complejo
